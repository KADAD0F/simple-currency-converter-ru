...
- Kali Linux (2025.1): успешно протестировано, корректная работа с локализацией
- Termux (Android 13): все функции доступны, включая сохранение данных в локальную БД
